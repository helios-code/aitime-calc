# SEO follow-up: strip tracking params from canonical + hreflang URLs

## Team : dev (niwa)
## Branch : feat/web-canonical-utm-strip (from main)
## Relay task : 2c24c84d-f1a6-4788-9b15-3a444f34ed44
## Status : 🔵 SUBMITTED

## 1. Product Brief

### Acceptance Criteria
- [ ] 1. canonical URL emitted without utm_* and known tracking params (gclid, fbclid, ref) on pages requested with them
- [ ] 2. hreflang alternate URLs equally stripped
- [ ] 3. ?lang param preserved in canonical/hreflang where it drives locale
- [ ] 4. EN pages unchanged in behavior except param stripping
- [ ] 5. tests cover: tracked request -> clean canonical/hreflang, lang preserved
- [ ] 6. gate-check green (api + web)
...
```
web/middleware.test.ts | 33 +++++++++++++++++++++++++++++++++
 web/middleware.ts      | 16 +++++++++++++++-
...
---
_Auto-assembled by the niwa scribe from the Q&A gate. Task `2c24c84d-f1a6-4788-9b15-3a444f34ed44`._
